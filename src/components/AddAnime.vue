<template>
  <div class="review-container">
      <h1>ADD AN ANIME</h1>
      <div class="input-row">
          <input type="text" v-model="anime.name" placeholder="Insert Anime Title">
      </div>
      <div class="input-row">
          <input type="text" v-model="anime.imageURL" placeholder="Insert Anime Image Address">
      </div>
      <div class="input-row">
          <textarea v-model="anime.description" placeholder="Give a brief description of the anime"></textarea>
      </div>
  </div>
  <div class="input-row">
