<template>
    <div class="anime-reviews">
      ...
      <div class="button-container">
        <button @click="filterReviews(1)" class="rating-button">1 Star Reviews</button>
        <button @click="filterReviews(2)" class="rating-button">2 Star Reviews</button>
        <button @click="filterReviews(3)" class="rating-button">3 Star Reviews</button>
        <button @click="filterReviews(4)" class="rating-button">4 Star Reviews</button>
        <button @click="filterReviews(5)" class="rating-button">5 Star Reviews</button>
      </div>
  ...
  export default {
    ...
    methods: {
      filterReviews(rating) {
        ...
        this.filteredReviews = this.reviews.filter(review => parseInt(review.rating) === rating);
      }
    }
  };
  </script>
